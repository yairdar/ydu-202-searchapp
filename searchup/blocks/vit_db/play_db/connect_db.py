...
def create_table():
    try:
        ...
        create_table_query = '''CREATE TABLE second_part_movies
...
def add_row(movie, id):
    try:
        ...
        #print(f""" INSERT INTO movies (id, name, year_date, budget,revenue,vote_average) VALUES  ('{movie.name}', {movie.year_date}, {movie.budget}, {movie.revenue}, {movie.vote_average})""")
        insert_query = f""" INSERT INTO second_part_movies (id, name, year_date, budget,revenue,vote_average) VALUES  ({id},'{movie.name}', {movie.year_date}, {movie.budget}, {movie.revenue}, {movie.vote_average})"""
...
if __name__ == "__main__":
    ...
    fill_db(file_name_csv, 500, 6000)# When fill the table don't forget change table name
